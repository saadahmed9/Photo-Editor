...
def verify_functionality_passed(request):
    ...
    if val not in functionality_list:
        raise SuspiciousOperation("Please select the function from the following list  ['passport_photo_size','background_change','photo_college','noise_removal','format_change','resize']")
