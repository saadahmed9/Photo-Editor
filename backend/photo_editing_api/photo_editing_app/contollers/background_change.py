...
def color_bg_and_add_border(input_image_path, output_image_path, bg_color, border_color=(0,0,0), border_thickness=2):
    ...
    change_bg.load_pascalvoc_model(R"E:\Career\University at Buffalo\Semester 2\CSE_611\project\cse611-spring2023-team-photo-editing\backend\photo_editing_api\media\models\deeplabv3_xception_tf_dim_ordering_tf_kernels.h5")
