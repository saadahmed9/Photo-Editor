...
ROOT_URLCONF = 'pdf_noise_brightness_api.urls'
CRON_CLASSES = {
    'pdf_noise_brightness_app.contollers.cron1.MyCronJob'
}
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'pdf_noise_brightness_api.wsgi.application'
