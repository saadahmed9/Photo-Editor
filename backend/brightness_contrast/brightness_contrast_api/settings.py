...
ROOT_URLCONF = 'brightness_contrast_api.urls'
CRON_CLASSES = {
    'brightness_contrast_app.contollers.cron1.MyCronJob'
}
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'brightness_contrast_api.wsgi.application'
