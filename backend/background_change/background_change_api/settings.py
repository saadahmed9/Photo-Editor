...
ROOT_URLCONF = 'background_change_api.urls'
CRON_CLASSES = {
    'background_change_app.contollers.cron1.MyCronJob'
}
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'background_change_api.wsgi.application'
